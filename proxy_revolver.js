...
function c177002_InnityAppsRevolver(options) {
  ...
  function isSupported_() {
    // console.log(curWin_.innerWidth * curWin_.innerHeight + '-' + supportedMaxWidth_ * supportedMaxHeight_);
    ...
    function isPlatformSupported_() {
      ...
      if (platform_.getOS() !== 'ios' && platform_.getOS() !== 'android') {
        isSupported_ = false;
        console.log('Not mobile platform, platform detected is '+platform_.getOS());
      }
console.log('con meo keu meo meo');
    ...
    function isScreenSizeSupported_() {
      ...
      if (curWin_.innerWidth * curWin_.innerHeight > supportedMaxWidth_ * supportedMaxHeight_) {
        isSupported_ = false;
        console.log('Screen size too big. width='+curWin_.innerWidth+' height='+curWin_.innerHeight+' dimension='+(curWin_.innerWidth * curWin_.innerHeight));
      }
